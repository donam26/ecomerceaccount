            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('topup.show', $service->slug) }}" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-sm">
                            Xem chi tiết
                        </a>
                    </div>
                </div>
