                ...
                <div class="p-6 lg:p-8">
                    ...
                    <div class="grid gap-4">
                        @if(isset($isBoostingOrder) && $isBoostingOrder)
                            ...
                            @endif
                        @else
                            <a href="{{ route('orders.show', $order->order_number) }}" class="flex justify-center items-center bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-3 px-4 rounded-full transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
