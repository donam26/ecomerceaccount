    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="md:hidden mobile-menu hidden bg-gray-800 w-full absolute z-10">
            <nav class="px-4 py-2">
                ...
                <a href="{{ route('admin.boosting_orders.index') }}" class="{{ request()->routeIs('admin.boosting_orders.*') ? 'bg-gray-900' : '' }} block px-4 py-2 text-white rounded-md">Đơn hàng cày thuê</a>
            </nav>
        </div>
