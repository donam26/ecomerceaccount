...
class TopUpOrder extends Model
{
    ...
    /**
     * Lấy dịch vụ nạp thuê liên quan
     */
    public function service()
    {
        return $this->belongsTo(TopUpService::class, 'service_id');
    }
    ...
    {
        return $this->hasMany(Transaction::class, 'top_up_order_id');
    }
    ...
    /**
     * Kiểm tra xem đơn hàng đã có thông tin ID game chưa
     */
